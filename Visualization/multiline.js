function makeLineChart(dataset, xName, yNames) {
    ...
    var colorFunct = d3.schemeCategory10
    ...
    chart.bind = function (bindOptions) {
        ...
        chart.xScale = d3.scaleLinear().range([0, chart.width]).domain(d3.extent(chart.data, chart.xFunct));
        chart.yScale = d3.scaleLinear().range([chart.height, 0]).domain([0, getYMax()]);
